...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 md:space-y-8">
      ...
      {/* Team Filter */}
      {teams.length > 0 && (
        <div className="flex flex-wrap items-center gap-4 p-5 rounded-xl bg-zinc-900/50 border border-zinc-800/50 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-zinc-800/50">
              <Users className="h-4 w-4 text-zinc-400" />
            </div>
            <span className="text-sm font-semibold text-zinc-300">Filter by team:</span>
          </div>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-32">
          <div className="relative">
            ...
            <div className="absolute inset-0 w-20 h-20 border-4 border-transparent border-t-zinc-600 rounded-full animate-spin animation-delay-150" style={{ animationDirection: "reverse" }} />
          </div>
          ...
          <div className="lg:col-span-2">
            <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm h-full shadow-2xl">
              <CardContent className="flex flex-col items-center justify-center py-24 space-y-8">
                <div className="relative">
                  <div className="w-28 h-28 rounded-full bg-zinc-800 flex items-center justify-center text-6xl shadow-2xl ring-4 ring-zinc-800/50 ring-offset-4 ring-offset-black">
                    ✨
                  </div>
                </div>
                <div className="text-center space-y-4 max-w-md">
                  ...
                  <p className="text-zinc-400 text-base leading-relaxed">
                    Start by creating your first project to enable AI-powered code reviews and streamline your development workflow
                  </p>
                </div>
                <Button
                  onClick={() => router.push("/dashboard/projects/new")}
            ...
            >
              <CardHeader className="pb-5 pt-6">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <CardTitle className="text-xl font-bold text-white group-hover:text-zinc-100 transition-colors line-clamp-1">
                      ...
                      <CardDescription className="mt-3 flex items-center gap-2.5">
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-800/50 border border-zinc-700/50 group-hover:border-zinc-600 transition-colors">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <div className={cn(
                      "flex items-center gap-2.5 px-4 py-2.5 rounded-lg border transition-all duration-300",
                      project.autoReview
                      ...
                      <div className={cn(
                        ...
                        <Activity className={cn(
                          "h-3.5 w-3.5",
                          project.autoReview ? "text-emerald-400" : "text-zinc-500"
                        )} />
                      </div>
                      <span className={cn(
                        "text-sm font-semibold",
                        project.autoReview ? "text-emerald-400" : "text-zinc-400"
                      )}>
