    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 md:space-y-8">
      ...
      <Card className="bg-zinc-900/70 border-emerald-400/20 backdrop-blur-sm hover:border-emerald-400/40 shadow-2xl transition-all duration-300">
        <CardHeader className="border-b border-zinc-800/50 pb-5 pt-6">
          <CardTitle className="flex items-center gap-3 text-xl font-bold bg-gradient-to-r from-emerald-300 via-white to-emerald-300 bg-clip-text text-transparent">
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col sm:flex-row items-center gap-8">
            <Avatar className="h-20 w-20 ring-4 ring-emerald-400/30 ring-offset-4 ring-offset-black">
              <AvatarFallback className="bg-gradient-to-br from-zinc-600 to-zinc-800 text-2xl font-bold text-white">
