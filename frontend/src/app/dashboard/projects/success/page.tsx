          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-zinc-400">
                ...
                is ready for AI-powered code reviews
              </p>
            </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <Badge
                      variant="outline"
                      className="bg-[#3b8df95f] text-white border-blue-500/30 mt-1"
                    >
                      Step 1
                    </Badge>
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-zinc-400 mb-3">
                        Set up the webhook in your repository to enable
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-zinc-400 mb-3">
                        Once the webhook is configured, create a Pull Request in
                        your repository. The AI will automatically review your
                        code changes and provide inline comments.
                      </p>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-zinc-400">
                        Review the AI comments on your Pull Request. You can
                        reply to comments, ask questions, or provide feedback.
                        The AI will learn from your interactions to improve
                        future reviews.
                      </p>
                    </div>
                  </div>
              ...
              <CardContent className="pt-6">
                ...
                <ul className="text-sm text-zinc-400 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Add business context in project settings to get more
                      relevant reviews
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-zinc-500">•</span>
                    <span>
                      Mention @ai-reviewer in comments to ask questions about
                      your code
                    </span>
                  </li>
                </ul>
