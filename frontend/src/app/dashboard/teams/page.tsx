              ...
              <CardHeader className="pb-5 pt-6">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 space-y-3">
                    <CardTitle className="text-xl font-bold text-white flex items-center gap-2.5 group-hover:text-zinc-100 transition-colors">
                      {team.name}
                      {team.role === "owner" && (
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2 p-4 rounded-lg bg-zinc-800/20 border border-zinc-800">
                  ...
                  <div className="flex justify-between items-center pt-3 border-t border-zinc-700/50">
                    <span className="text-sm text-zinc-400">Members Limit</span>
                    <span className="font-semibold text-white">
